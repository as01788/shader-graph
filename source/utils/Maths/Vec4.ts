...
import { IVec4Like, IMat4Like, IQuatLike } from "./type-define";
import { EPSILON, random, clamp } from "./utils";
 ...
 */
 export class Vec4  {
     ...
     */
    public static toArray <Out> (out: Out, v: IVec4Like, ofs = 0) {
        out[ofs + 0] = v.x;
        out[ofs + 1] = v.y;
        out[ofs + 2] = v.z;
        out[ofs + 3] = v.w;
     ...
     * @param ofs Array Start Offset
     */
    public static fromArray <Out extends IVec4Like> (out: Out, arr, ofs = 0) {
        out.x = arr[ofs + 0];
        out.y = arr[ofs + 1];
        out.z = arr[ofs + 2];
        out.w = arr[ofs + 3];
