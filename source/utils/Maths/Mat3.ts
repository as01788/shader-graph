...
import { IMat3Like, IMat4Like, IVec3Like, IVec2Like, IQuatLike } from "./type-define";
...
import { Vec3 } from "./Vec3";
 ...
 export class Mat3 {
     ...
     */
    public static toArray <Out> (out: Out, m: IMat3Like, ofs = 0) {
        out[ofs + 0] = m.m00;
        out[ofs + 1] = m.m01;
        out[ofs + 2] = m.m02;
        out[ofs + 3] = m.m03;
     ...
     * @param ofs Array Start Offset
     */
    public static fromArray <Out extends IMat3Like> (out: Out, arr, ofs = 0) {
        out.m00 = arr[ofs + 0];
        out.m01 = arr[ofs + 1];
        out.m02 = arr[ofs + 2];
        out.m03 = arr[ofs + 3];
